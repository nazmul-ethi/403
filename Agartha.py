    ...
    def authenticationMatrixThread(self, ev, _matrixList):
        ...
        try:
            ...
            for x in range(0, self.tableMatrixAuthentication_DM.getRowCount()):
                ...
                _reqMethods = ["ABC ", "TRACE ", "CONNECT ", "PATCH ", "DEBUG ", "PUT", "POST", "HEAD", "LOCK", "UPDATE", "TRACK", "OPTIONS", "DELETE", "X", "ADMIN", "NOTHINGS", "PRI", "BIND", "CHECKOUT", "MKCALENDAR", "ORDERPATCH", "PROPFIND", "SEARCH", "UNLINK", "UPDATE"]
